...
<div class="flex flex-col gap-6">
	...
	<p>
		I've worked on a wide range of projects, from small websites to large enterprise applications. I
		really shine when I'm working at the intersection of software development and core business
		needs. I'm able to take many variables and factors into account that my peers are not familiar
		with, including sales funnels; conversion rates; user journeys; regulations and compliance;
	...
	<p>
		I'm easily reachable at <a
			...
			class="link">my profile on LinkedIn</a
		>.
	</p>
</div>
